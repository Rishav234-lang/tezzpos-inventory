...
final customerListProvider = FutureProvider.autoDispose.family<Map<String, dynamic>, Map<String, String>>((ref, params) async {
...
class _CustomerListScreenState extends ConsumerState<CustomerListScreen> {
  ...
  Widget build(BuildContext context) {
    final customersAsync = ref.watch(customerListProvider(_params));
        ...
        children: [
          ...
          Expanded(
            child: customersAsync.when(
              ...
              error: (err, _) => AppErrorWidget(message: err.toString(), onRetry: () => ref.invalidate(customerListProvider)),
              data: (result) {
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            ...
                            onTap: () => context.go('/customers/${c['id']}/edit'),
                          );
                        },
                      ),
                    ),
