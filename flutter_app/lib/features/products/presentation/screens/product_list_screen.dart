...
final productListProvider = FutureProvider.family<Map<String, dynamic>, Map<String, String>>((ref, params) async {
        ...
        children: [
          ...
          Expanded(
            ...
            child: productsAsync.when(
              ...
              error: (err, _) => AppErrorWidget(message: err.toString(), onRetry: () => ref.invalidate(productListProvider(_currentParams))),
                ...
                return Column(
                  ...
                  children: [
                    ...
                    if (pagination != null && (pagination['totalPages'] ?? 1) > 1)
                      ...
                      _PaginationBar(page: _page, totalPages: pagination['totalPages'] ?? 1, total: pagination['total'] ?? 0, onPageChanged: (p) => setState(() { _page = p; _updateParams(); })),
