...
final vendorListProvider = FutureProvider.family<Map<String, dynamic>, Map<String, String>>((ref, params) async {
...
class _VendorListScreenState extends ConsumerState<VendorListScreen> {
  ...
  Future<void> _deleteVendor(String id, String name) async {
    ...
    try {
      ...
      ref.invalidate(vendorListProvider(_currentParams));
  ...
  Widget build(BuildContext context) {
    ...
    final vendorsAsync = ref.watch(vendorListProvider(_currentParams));
        ...
        children: [
          ...
          Expanded(
            ...
            child: vendorsAsync.when(
              ...
              error: (err, _) => AppErrorWidget(message: err.toString(), onRetry: () => ref.invalidate(vendorListProvider(_currentParams))),
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: RefreshIndicator(
                        onRefresh: () async {
                          ref.invalidate(vendorListProvider(_currentParams));
                          await ref.read(vendorListProvider(_currentParams).future);
                        },
